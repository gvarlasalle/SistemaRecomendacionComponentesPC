# backend/ml_models/train_deepfm.py
"""
Entrena el modelo DeepFM
"""
...
def train_deepfm_model():
    ...
    print("\n" + "="*60)
    print("🧠 ENTRENAMIENTO MODELO DEEPFM")
    print("="*60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            model_path = Path(__file__).parent / 'deepfm_model_best.pth'
            torch.save({
                'epoch': epoch,
    ...
    print(f"💾 Modelo guardado en: ml_models/deepfm_model_best.pth")
    print("="*60 + "\n")
